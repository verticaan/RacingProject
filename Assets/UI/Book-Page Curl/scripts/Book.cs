...
public class Book : MonoBehaviour {
    ...
    public Button page1Button; // Reference to the button for page 1
    public Button page2Button; // Reference to the button for page 2
    public Button page3Button; // Reference to the button for page 3
