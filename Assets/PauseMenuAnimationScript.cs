...
public class PauseMenuAnimationScript : MonoBehaviour
{
    ...
    [SerializeField] GameObject leftTriangle, pauseCanvas, trackImage, trackName, resumeButton, restartButton, OptionsButton, Quitbutton;
 public void PauseMenuAnimIn()
    {
        ...
        LeanTween.moveLocal(pauseCanvas, new Vector3(462f, 0f, 0f), 0.5f).setDelay(0.3f).setEase(LeanTweenType.easeSpring).setIgnoreTimeScale(true);
    ...
    public void PauseMenuAnimOut()
    {
        ...
        LeanTween.moveLocal(pauseCanvas, new Vector3(883f, 0f, 0f), 0.5f).setDelay(0.3f).setEase(LeanTweenType.easeSpring).setIgnoreTimeScale(true);
